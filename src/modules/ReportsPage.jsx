...
import { ArrowBack, BarChart, Add } from '@mui/icons-material';
    ...
    <Box sx={{ p: { xs: '16px', md: '20px 24px' }, maxWidth: 1440 }}>
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 2 }}>
        ...
        <Box>
          ...
          <Typography sx={{ fontSize: '0.75rem', color: '#94A3B8' }}>Rent yield, vacancy, expense trends</Typography>
        </Box>
      </Box>
      ...
      <Card sx={{ p: 5, textAlign: 'center', bgcolor: '#F8FAFC', border: '2px dashed #E2E8F0' }}>
        <Box sx={{ p: '12px', borderRadius: '14px', bgcolor: '#7C3AED08', display: 'inline-flex', mb: 2 }}>
          <BarChart sx={{ fontSize: 36, color: '#7C3AED' }} />
        </Box>
        <Typography sx={{ fontWeight: 700, fontSize: '1.1rem', color: '#0F172A', mb: 0.5 }}>Reports & Analytics</Typography>
        <Typography sx={{ fontSize: '0.82rem', color: '#94A3B8', maxWidth: 400, mx: 'auto', lineHeight: 1.5 }}>
          Rent yield, vacancy, expense trends. This module is ready for development — the navigation and routing are fully wired up.
        </Typography>
