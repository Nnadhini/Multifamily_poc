    ...
    <Box sx={{ p: { xs: '16px', md: '20px 24px' }, maxWidth: 1440 }}>
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 2 }}>
        ...
        <Box sx={{ p: '6px', borderRadius: '10px', bgcolor: '#7C3AED12' }}>
          <People sx={{ fontSize: 20, color: '#7C3AED' }} />
        </Box>
        <Box>
          <Typography sx={{ fontWeight: 800, fontSize: '1.4rem', color: '#0F172A' }}>AI Tenant Screening</Typography>
          <Typography sx={{ fontSize: '0.75rem', color: '#94A3B8' }}>Risk score, fraud check, verification</Typography>
        </Box>
      </Box>
      ...
      <Card sx={{ p: 5, textAlign: 'center', bgcolor: '#F8FAFC', border: '2px dashed #E2E8F0' }}>
        <Box sx={{ p: '12px', borderRadius: '14px', bgcolor: '#7C3AED08', display: 'inline-flex', mb: 2 }}>
          <People sx={{ fontSize: 36, color: '#7C3AED' }} />
        </Box>
        <Typography sx={{ fontWeight: 700, fontSize: '1.1rem', color: '#0F172A', mb: 0.5 }}>AI Tenant Screening</Typography>
        <Typography sx={{ fontSize: '0.82rem', color: '#94A3B8', maxWidth: 400, mx: 'auto', lineHeight: 1.5 }}>
          Risk score, fraud check, verification. This module is ready for development — the navigation and routing are fully wired up.
        </Typography>
