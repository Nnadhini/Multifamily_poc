...
import { ArrowBack, Campaign, Add } from '@mui/icons-material';
    ...
    <Box sx={{ p: { xs: '16px', md: '20px 24px' }, maxWidth: 1440 }}>
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 2 }}>
        ...
        <Box sx={{ p: '6px', borderRadius: '10px', bgcolor: '#DC262612' }}>
          <Campaign sx={{ fontSize: 20, color: '#DC2626' }} />
        </Box>
        <Box>
          <Typography sx={{ fontWeight: 800, fontSize: '1.4rem', color: '#0F172A' }}>Renewal Nudger</Typography>
          <Typography sx={{ fontSize: '0.75rem', color: '#94A3B8' }}>Auto-remind tenants, smart discounts</Typography>
        </Box>
      </Box>
      ...
      <Card sx={{ p: 5, textAlign: 'center', bgcolor: '#F8FAFC', border: '2px dashed #E2E8F0' }}>
        <Box sx={{ p: '12px', borderRadius: '14px', bgcolor: '#DC262608', display: 'inline-flex', mb: 2 }}>
          <Campaign sx={{ fontSize: 36, color: '#DC2626' }} />
        </Box>
        <Typography sx={{ fontWeight: 700, fontSize: '1.1rem', color: '#0F172A', mb: 0.5 }}>Renewal Nudger</Typography>
        <Typography sx={{ fontSize: '0.82rem', color: '#94A3B8', maxWidth: 400, mx: 'auto', lineHeight: 1.5 }}>
          Auto-remind tenants, smart discounts. This module is ready for development — the navigation and routing are fully wired up.
        </Typography>
