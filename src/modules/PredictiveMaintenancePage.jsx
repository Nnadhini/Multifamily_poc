  ...
  return (
    <Box sx={{ p: { xs: '16px', md: '20px 24px' }, maxWidth: 1440 }}>
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 2 }}>
        ...
        <Box sx={{ p: '6px', borderRadius: '10px', bgcolor: '#D9770612' }}>
          <Build sx={{ fontSize: 20, color: '#D97706' }} />
        </Box>
        <Box>
          <Typography sx={{ fontWeight: 800, fontSize: '1.4rem', color: '#0F172A' }}>Predictive Maintenance</Typography>
          <Typography sx={{ fontSize: '0.75rem', color: '#94A3B8' }}>Flag issues before they escalate</Typography>
        </Box>
      </Box>
      ...
      <Box sx={{ display: 'flex', justifyContent: 'flex-end', gap: 0.75, mb: 2.5 }}>
        ...
        <Button variant="contained" size="small" startIcon={<Add sx={{ fontSize: '14px !important' }} />}
          sx={{ fontSize: '0.72rem', height: 32, borderRadius: '8px', bgcolor: '#D97706' }}>Add New</Button>
      </Box>

      <Card sx={{ p: 5, textAlign: 'center', bgcolor: '#F8FAFC', border: '2px dashed #E2E8F0' }}>
        <Box sx={{ p: '12px', borderRadius: '14px', bgcolor: '#D9770608', display: 'inline-flex', mb: 2 }}>
          <Build sx={{ fontSize: 36, color: '#D97706' }} />
        </Box>
        <Typography sx={{ fontWeight: 700, fontSize: '1.1rem', color: '#0F172A', mb: 0.5 }}>Predictive Maintenance</Typography>
        <Typography sx={{ fontSize: '0.82rem', color: '#94A3B8', maxWidth: 400, mx: 'auto', lineHeight: 1.5 }}>
          Flag issues before they escalate. This module is ready for development — the navigation and routing are fully wired up.
        </Typography>
        <Chip label="Module Ready for Development" size="small" sx={{ mt: 2, bgcolor: '#D9770610', color: '#D97706', fontWeight: 600 }} />
      </Card>
    </Box>
  );
}
